...
3.) After install neovim. Install other needed item. - C compiler like: "cc", "gcc", "clang", "cl", "zig" - I installed zig using winget. - Install node, it is needed in mson when installing other plugins like (prettier, etc..)

4.) After installation of c compiler and node, clone the lua config. - go to your .\AppData\Local\
 - create a folder name "nvim" - paste the copied/extracted file from this repo.
